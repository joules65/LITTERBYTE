...
import { Loader2, Award, User, Trophy, Crown } from "lucide-react"
import toast from "react-hot-toast";
import { getAllRewards, getUserByEmail } from "@/utils/database/actions";
import RewardCount from "@/components/rewardCount";
    ...
    useEffect(() => {
      ...
      return (
        <div className="">
          ...
          <h1 className="text-5xl text-center font-semibold mb-6 text-green-950">Leaderboard </h1>
